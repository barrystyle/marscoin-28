...
static RPCHelpMan getauxcheckpoint()
{
    return RPCHelpMan{"getauxcheckpoint",
        ...
        RPCExamples{
            HelpExampleCli("getauxcheckpoint", "")
            + HelpExampleRpc("getauxcheckpoint", "")
        },
